...
ECS_COMPONENT_DECLARE(PositionF32);
ECS_COMPONENT_DECLARE(RectangleF32);
...
int main (int argc, char * argv[])
{
	...
	ECS_COMPONENT_DEFINE(world, PositionF32);
	ECS_COMPONENT_DEFINE(world, RectangleF32);
	...
	*/
	...
	struct gtext1_context tctx = {0};
	tctx.filename = CSC_SRCDIR"consola.ttf";
	tctx.ft = ft;
	tctx.maxwidth = 512;
	tctx.pixel_width = 48;
	tctx.pixel_height = 48;
	...
	while (main_flags & CSC_SDLGLEW_RUNNING)
	{
...

		{
			...
			vgraphics_drawtext (&vg, tctx.c, &tctx.atlas, -1.0f, 0.0f, 0.0f, 0.1f/48.0f, 0.1f/48.0f, 0.0f, -0.1f, "A B C\nD-E-F\n\n1_2_3\n!#&");
			int w;
			int h;
